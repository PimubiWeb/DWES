    ...
    <?php
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            try{
                ...
                echo preg_match('/[\s]/', $nombre);
                $apellidos = $_REQUEST["sname"];
                $edad = (int)$_REQUEST["age"];
                
                if(isset($nombre)){
                    if(is_string($nombre) && !(preg_match('/[\W\d_]/', $nombre)) && !preg_match('/[\s]/', $nombre))
                ...
                if(isset($apellidos)){
                    if(is_string($apellidos) && !(preg_match('/[\W\d_]/', $apellidos)) && !preg_match('/[\s]/', $apellidos))
