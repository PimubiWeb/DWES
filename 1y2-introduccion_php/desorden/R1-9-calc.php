...
<?php
//Escribe un programa que permita realizar las operaciones básicas de una calculadora:
//suma, resta, multiplicación y división. (Deberemos recoger dos números por URL con GET)
