...
//Haz un script para mostrar todos los números comprendidos entre los dos valores que nos lleguen por la URL.
//Por ejemplo, si llegan el 5 y el 9 mostraremos los valores 6,7 y 8.
