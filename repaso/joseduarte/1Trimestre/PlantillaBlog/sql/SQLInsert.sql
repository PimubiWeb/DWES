USE BLOG_PROJECT;
INSERT INTO ENTRADAS(USUARIO_ID, CATEGORIA_ID, TITULO, DESCRIPTION, FECHA) VALUES (1, 1, 'Java Best Practices', 'Following are the top 15 Java best Practices that you should start following to upgrade your coding standards  
<ol>
...
INSERT INTO ENTRADAS(USUARIO_ID, CATEGORIA_ID, TITULO, DESCRIPTION, FECHA) VALUES (1, 2, 'HTML Design Best Practices', 'Whether you are a beginner or an expert in Hyper Text Markup Language (HTML) it is important to follow some best practices in order to keep your HTML documents consistent and organized. With so many elements, attributes, properties, values, and more—there is a lot to learn.
