...
function dame_datos_sesion()
{
	return "El identificador devuelto por la función session_id() es:<p>
			    <b><p style="."color:#002FA7".";>".session_id()."</p></b>
                <p>El fichero que almacena los datos del identificador se ha guardado en el directorio:</p>
			    <b><p style="."color:#002FA7".";>".session_save_path()."</p></b>
                <p>El nombre definido en php.ini para la sesión (nombre de la cookie) es: </p>
			    <b><p style="."color:#002FA7".";>".session_name()."</p></b>
            </p>";
}
...
echo "<HTML>
		<HEAD><TITLE>Ejemplo Sesiones </TITLE></HEAD>
		<BODY>$resultadoStr
