...
if(isset($_POST)){
	...
	if(count($errores) == 0){
		...
		// comprobamos si el email ya lo tiene algun otro usuario
		...
		if($isset_user['id'] == $usuario['id'] || empty($isset_user)){
			...
			//ahora lo guardamos en las sesiones
			if($guardar){
			...
			$_SESSION['errores']['general'] = "El usuario ya existe, inserte otro por favor.";
		}
